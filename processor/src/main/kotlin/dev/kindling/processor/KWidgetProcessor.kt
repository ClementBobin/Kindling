...
class KWidgetProcessor(
    ...
    private fun generateRegistryFile(resolver: Resolver, functions: List<KSFunctionDeclaration>) {
        try {
            val modelFqn = findFullyQualifiedName(resolver, "KWidgetModel") ?: "dev.kindling.core.components.ui.dashboard.KWidgetModel"
            val metadataFqn = findFullyQualifiedName(resolver, "KWidgetMetadata") ?: "dev.kindling.core.components.ui.dashboard.KWidgetMetadata"
            ...
            file.bufferedWriter().use { writer ->
                ...
                if (functions.isEmpty()) {
                    writer.write("val GeneratedWidgetCatalog: List<KWidgetMetadata> = emptyList()\n")
                } else {
