 ...
 *
 * `SimpleScreen` is the legacy-tier counterpart to
 ...
 * ## When to use
 *
 * Use `SimpleScreen` when your ViewModel extends [KSimpleViewModel].
 ...
 * ```kotlin
 * // In your ViewModel:
 * sendEvent(Screen.Home)          // ← automatically navigated by SimpleScreen
 ...
 */
@Composable
fun <State, VM : KSimpleViewModel<State>> SimpleScreen(
    viewModel: VM,
    navController: NavController,
