...
fun Double.toSignedPercent(decimals: Int = 1): String {
    ...
    return "$sign${String.format(java.util.Locale.US, "%.${decimals}f", kotlin.math.abs(value))}%"
}
...
fun Double.toChangeLabel(previous: Double, decimals: Int = 1): String {
    ...
    return "$sign${String.format(java.util.Locale.US, "%.${decimals}f", kotlin.math.abs(pct))}%"
}
